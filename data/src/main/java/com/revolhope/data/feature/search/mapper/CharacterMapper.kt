...
object CharacterMapper {
    ...
    fun fromCharactersResponseToModel(response: CharactersResponse): List<CharacterModel> =
        response.results?.map(::fromCharacterResponseToModel) ?: emptyList()

    private fun fromCharacterResponseToModel(response: CharacterResponse): CharacterModel =
        CharacterModel(
